...
(define (desugar [as : ExprS]) : ExprC
  (type-case ExprS as
    ...
    [letrecS (f e expr)   (letC f (quoteC 'al) (seqC (setC f (desugar e)) (desugar expr)))]
    [quoteS  (sim)        (quoteC sim)]
    [loadS   (l)          (loadC (desugar l))]
    ))
...
(define (interp [a : ExprC] [env : Env]) : Value
  (type-case ExprC a
    ...
    [let*C (name1 arg1 name2 arg2 body)
           (let* ([new-bind (bind name1 (box (interp arg1 env)))]
                  [new-env (extend-env new-bind env)]
                  [new-bind1 (bind name2 (box (interp arg2 new-env)))]
...
; Parser entender expressões que vamos escrever
